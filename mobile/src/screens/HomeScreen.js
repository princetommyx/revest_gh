...
const CATEGORIES = [
    { id: '', name: 'All', icon: LayoutGrid, color: '#455A64', bg: '#fff' },
    { id: 'Plastics', name: 'Plastics', icon: Droplet, color: '#111', bg: '#fff' },
    { id: 'Metals', name: 'Metals', icon: Cog, color: '#5D4037', bg: '#fff' },
    { id: 'Paper', name: 'Paper', icon: FileText, color: '#FBC02D', bg: '#fff' },
    { id: 'Glass', name: 'Glass', icon: Wine, color: '#00796B', bg: '#fff' },
    { id: 'Electronics', name: 'E-Waste', icon: Cpu, color: '#7B1FA2', bg: '#fff' }
];
...
export default function HomeScreen({ navigation }) {
    ...
    const renderCategory = (item) => {
        ...
        return (
            ...
            >
                {isActive ? null : <IconComp size={16} color="#111" style={{ marginRight: 6 }} />}
                ...
                ListHeaderComponent={<>
                                ...
                                <View style={styles.userInfoText}>
                                    ...
                                    {user?.city ? (
                                        <View style={styles.locationDropdown}>
                                            <MapPin size={12} color="#888" />
                                            <Text style={styles.locationTextHeader}>{user.city}</Text>
                                        </View>
                                    ) : null}
                                </View>
                            </View>
                    ...
                    <View style={styles.section}>
                        <View style={[styles.sectionHeader, { paddingHorizontal: 20 }]}>
                            <Text style={styles.sectionTitle}>{userRole === 'RECYCLER' ? 'Recent Jobs' : 'Waste Around You'}</Text>
                            <TouchableOpacity onPress={() => navigation.navigate('Pickups')}><Text style={styles.viewAllText}>View All</Text></TouchableOpacity>
                        </View>
                    </View>
                </>}
